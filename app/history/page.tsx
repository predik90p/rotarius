...
import { ArrowRight, Target, Globe, Cpu, Factory, GraduationCap, Wrench, Users, Radio, Shield, Sprout, Flame } from "lucide-react"
...
const products = [
  { icon: Sprout, name: "Agriculture Drones", description: "High-performance spraying drones and precision agriculture services. Monitoring, mapping, and autonomous crop treatment at scale.", link: "/solutions/agro", color: "bg-white/70 hover:bg-[#fdf2b1] border-stone-200 hover:border-yellow-200/50" },
  { icon: Shield, name: "Defense UAS", description: "Tactical multirotor platforms with jam-resistant radios, AI-powered cameras, and universal payload release systems. Battle-proven.", link: "/solutions/military", color: "bg-white/70 hover:bg-blue-50 border-stone-200 hover:border-blue-200" },
  { icon: Flame, name: "Firefighting Drones", description: "Multi-functional platforms equipped with powder, foam, or bomb suppression systems. Built in collaboration with emergency rescue institutes.", link: "/solutions/firefighting", color: "bg-white/70 hover:bg-orange-50 border-stone-200 hover:border-orange-200" },
]
  ...
  return (
    <main className="min-h-screen bg-[#fcfcf9]">
      ...
      <section id="timeline" className="py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="text-center mb-20">
            <span className="text-sm font-semibold text-stone-400 tracking-widest uppercase">Our History</span>
            <h2 className="mt-4 text-4xl sm:text-5xl font-bold tracking-tight text-stone-900 leading-tight">
              ...
              {timeline.map((item, index) => (
                ...
                >
                  <div className={`flex-1 pl-20 lg:pl-0 ${index % 2 === 0 ? "lg:text-right lg:pr-16" : "lg:text-left lg:pl-16"}`}>
                    <div className="bg-white p-8 rounded-3xl border border-stone-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-500 inline-block max-w-lg">
                      <span className="text-sm font-bold text-stone-400 tracking-widest">{item.year}</span>
                      <h3 className="mt-3 text-2xl font-bold text-stone-900">{item.title}</h3>
                      <p className="mt-3 text-stone-500 leading-relaxed">{item.description}</p>
                    </div>
                  </div>

                  <div className="absolute left-8 lg:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-stone-900 border-4 border-[#fcfcf9] shadow-lg" />
      ...
      <section id="vision" className="py-24 lg:py-32 bg-stone-900 relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="text-sm font-semibold text-stone-400 tracking-widest uppercase">Our Philosophy</span>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={card.title}
                  className={`p-6 rounded-3xl border border-white/10 backdrop-blur-sm transition-all duration-500 hover:-translate-y-2 hover:border-white/20 ${i === 1 ? "bg-white/10" : "bg-white/5"
                    }`}
                >
                  <card.icon className={`w-8 h-8 mb-4 ${i === 1 ? "text-white" : "text-white/60"}`} />
      ...
      <section className="py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="text-center mb-20">
            <span className="text-sm font-semibold text-stone-400 tracking-widest uppercase">The Ecosystem</span>
            <h2 className="mt-4 text-4xl sm:text-5xl font-bold tracking-tight text-stone-900 leading-tight">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {ecosystemPillars.map((pillar, i) => (
              <div
                key={pillar.title}
                className="group bg-white rounded-3xl border border-stone-100 p-8 hover:-translate-y-2 hover:shadow-xl transition-all duration-500"
              >
                <div className="w-14 h-14 rounded-2xl bg-stone-50 flex items-center justify-center mb-6 group-hover:bg-stone-100 transition-colors duration-500">
                  <pillar.icon className="w-6 h-6 text-stone-400 group-hover:text-stone-600 transition-colors duration-500" />
                </div>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="text-center mb-20">
            <span className="text-sm font-semibold text-stone-400 tracking-widest uppercase">Solutions</span>
            <h2 className="mt-4 text-4xl sm:text-5xl font-bold tracking-tight text-stone-900 leading-tight">
      ...
      <section className="py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="text-sm font-semibold text-stone-400 tracking-widest uppercase">Key Components</span>
              <h2 className="mt-4 text-4xl sm:text-5xl font-bold tracking-tight text-stone-900 leading-tight">
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={i}
                  className="flex items-start gap-4 bg-white p-5 rounded-2xl border border-stone-100 hover:border-stone-300 hover:shadow-md transition-all duration-300"
                >
