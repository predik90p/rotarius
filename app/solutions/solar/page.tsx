...
import { ArrowRight, Sun, Thermometer, Sparkles } from "lucide-react"
import { Button } from "@/components/ui/button"
import Link from "next/link"
import { useLocale } from "@/components/locale-provider"

const TYPE_COLOR = '#F5B700'
const ICONS = [Sun, Thermometer, Sparkles]

export default function SolarSolutionPage() {
  const { dict } = useLocale()
  const data = dict.solutions.solar
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative aspect-square w-full max-w-md ml-auto">
              <img src="/products/Kazhan-AGRO-30-agricultural-drone.jpg" alt="Solar Drone" className="w-full h-full object-cover rounded-[40px] shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
