  ...
  return (
    <main className="min-h-screen bg-[#fcfcf9]">
      ...
      <section className="pt-32 pb-16 text-center">
        ...
        <p className="mt-8 text-stone-500 text-xl max-w-2xl mx-auto">Delivering advanced technological integration for agriculture, global defense, and emergency response.</p>
      </section>
      <ServicesSection />
      <Footer />
    </main>
