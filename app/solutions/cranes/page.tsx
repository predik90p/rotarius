...
import { ArrowRight, Snowflake, Eye, Gauge } from "lucide-react"
import { Button } from "@/components/ui/button"
import Link from "next/link"
import { useLocale } from "@/components/locale-provider"

const TYPE_COLOR = '#3B82F6'
const ICONS = [Snowflake, Eye, Gauge]

export default function CranesSolutionPage() {
  const { dict } = useLocale()
  const data = dict.solutions.cranes
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative aspect-square w-full max-w-md ml-auto">
              <img src="/products/Kazhan-E620-Strike-UAS.jpg" alt="Crane Drone" className="w-full h-full object-cover rounded-[40px] shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
