        ...
        <div className="hidden lg:flex items-center gap-1 h-full">
          {navigation.map((item) => (
            ...
            >
              <Link
                href={item.href}
                className={`flex items-center gap-1.5 px-5 py-2.5 text-sm font-medium transition-all rounded-full ${item.active || activeMega === item.name
                    ...
                    <div className="grid grid-cols-12 gap-8 text-black">
                      ...
                      <div className="col-span-3 border-r border-stone-200 pr-8">
                        ...
                        <ul className="space-y-4 text-stone-500 font-medium">
                          <li><Link href="/products?category=military" className="hover:text-stone-900 transition-colors">Military UAS</Link></li>
                          <li><Link href="/products?category=agriculture" className="hover:text-stone-900 transition-colors">Agriculture</Link></li>
                          <li><Link href="/products?category=firefighting" className="hover:text-stone-900 transition-colors">Firefighting</Link></li>
                          <li><Link href="/products?category=isr" className="hover:text-stone-900 transition-colors">ISR & Reconnaissance</Link></li>
                          <li><Link href="/products?category=transport" className="hover:text-stone-900 transition-colors">Transport</Link></li>
                          <li><Link href="/products?category=components" className="hover:text-stone-900 transition-colors">Components</Link></li>
                        </ul>
                        <Link
                          href="/products"
                  ...
                  {item.name === "Solutions" && (
                    <div className="grid grid-cols-3 gap-12 text-black">
                      ...
                      <div className="flex flex-col justify-center">
                        <Link
                          href="/solutions"
                          className="inline-flex items-center gap-2 px-6 py-4 bg-stone-900 text-white text-sm font-semibold rounded-xl hover:bg-stone-800 transition-colors w-fit"
                        >
                          View All Solutions
                          <ArrowRight className="w-4 h-4" />
                        </Link>
